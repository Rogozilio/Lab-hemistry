    ...
    public class ForcepsForGranule : MonoBehaviour, IRestart
    {
        public enum StateForcepsForGranule
        {
            Empty,
            WithGranule,
            NotActive
        ...
        private StateForcepsForGranule _stateForceps;
        ...
        public StateForcepsForGranule GetState => _stateForceps;

        public int SetState
        {
            set => _stateForceps = (StateForcepsForGranule)value;
        }
        ...
        private void ActionForceps(bool isOpenForceps, int newState)
        {
            ...
            _stateForceps = (StateForcepsForGranule)newState;
        ...
        {
            _isOpenForceps = true;
            _stateForceps = StateForcepsForGranule.Empty;
