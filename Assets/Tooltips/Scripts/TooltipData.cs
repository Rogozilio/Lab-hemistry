...
public class TooltipData 
{
    ...
    [Tooltip("Данные в виде строки, используется как заголок или текст выноски, а также для описания полосы прогресса")]
    ...
    public TooltipData (Type type, string stringData, float numberData) 
    {
        this._type       = type;
    ...
    public TooltipData (ERA.Tooltips.Core.TooltipsInfo.Data info) 
    {
